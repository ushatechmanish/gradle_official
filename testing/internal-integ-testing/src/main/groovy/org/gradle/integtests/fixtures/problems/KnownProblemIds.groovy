...
class KnownProblemIds {
    ...
    private static final HashMap<String, String> KNOWN_DEFINITIONS = [
        ...
        'deprecation-logger:custom-task-action' : 'Custom Task action has been deprecated.',
        'deprecation-logger:executing-gradle-on-jvm-versions-and-lower': 'Executing Gradle on JVM versions 16 and lower has been deprecated.',
        'deprecation-logger:missing-java-toolchain-plugin' : 'Using task ValidatePlugins without applying the Java Toolchain plugin.',
