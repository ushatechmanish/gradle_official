...
public class ManagedObjectRegistry implements AnnotatedServiceLifecycleHandler {
    ...
    private void registerNoArgFactory(Method method, Object instance) {
        Factory<?> existing = noArgFactories.put(method.getReturnType(), () -> {
            try {
        ...
        if (existing != null) {
            throw new IllegalArgumentException("Method " + method + " annotated with @ManagedObjectCreator conflicts with existing factory for type " + method.getReturnType());
        }
    }
    ...
    private void registerSingleArgFactory(Method method, Class<?>[] parameterTypes, Object instance) {
        ...
        Function<Class<?>, ?> existing = singleArgFactories.put(method.getReturnType(), arg1 -> {
            try {
    ...
    private void registerTwoArgFactory(Method method, Class<?>[] parameterTypes, Object instance) {
        ...
        BiFunction<Class<?>, Class<?>, ?> existing = twoArgFactories.put(method.getReturnType(), (arg1, arg2) -> {
            try {
